...
import { Droplets, Calendar, FlaskConical, ChevronRight, Copy, Loader2 } from "lucide-react";
import {
  STAGE_LABELS,
  STAGE_COLORS,
  STAGE_DOT,
...
export function PlantCard({
  ...
  return (
    <motion.div
      ...
      className="bg-card/80 backdrop-blur-sm border border-white/5 rounded-2xl overflow-hidden transition-shadow duration-300 group cursor-pointer"
      style={{
        boxShadow: hovered
